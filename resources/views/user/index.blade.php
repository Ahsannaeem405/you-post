                                ...
                                <div class="form-wizard card my-2">
                                    ...
                                    <div class="form-wizard-header">
                                        ...
                                        <ul class="list-unstyled form-wizard-steps clearfix">
                                            ...
                                            <li section="fb"><span class="d-flex justify-content-center align-items-center"><img src="{{asset('images/FB_Color.png')}}" width="20px" alt=""></span></li>
                                            @endif
                                    ...
                                    <fieldset class="wizard-fieldset fb">
                                        ...
                                        <div class="form-group emoji_parent">
                                            <textarea onkeyup="updateDiv(this)" onchange="suggested_text(this)" required name="facebook_content" id="" cols="30" rows="3" class="form-control wizard-required emojiarea " placeholder="Write your post...">{{old('facebook_content')}}</textarea>
                                        </div>
                                        <div class="icon_buttons_tags mt-3">
                                            ...
                                            <div class="tags_input_wrap grid_item">
                                                <div class="tags_input">
                                                    <input onkeyup="Namechangefun(this)" id="namechange" name="facebook_tag" type="text" class="form-control ai-tag" placeholder="tags" value="{{old('facebook_tag')}}">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <fieldset class="wizard-fieldset insta">
                                        ...
                                        <div class="form-group emoji_parent">
                                            <textarea onkeyup="updateDiv(this)" onchange="suggested_text(this)" required name="instagram_content" id="" cols="30" rows="3" class="form-control wizard-required emojiarea " placeholder="Write your post...">{{old('instagram_content')}}</textarea>
                                        </div>
                                        <div class="icon_buttons_tags mt-3">
                                            <div class="icon_buttons grid_item">
                                                <ul class="p-0">
                                            ...
                                            <input type="file" name="insta_media" required class="image d-none file_image_video wizard-required" id="image_or_video_insta" accept="image/*,video/*">
                                            <input type="hidden" name="media_type_instagram" id="media_type_insta">


                                            <div class="tags_input_wrap grid_item">
                                                <div class="tags_input">
                                                    <input onkeyup="Namechangefun(this)" id="namechange" name="instagram_tag" type="text" class="form-control ai-tag" placeholder="tags" value="{{old('instagram_tag')}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group clearfix">
                                    ...
                                    <fieldset class="wizard-fieldset twitter">
                                        <h5>Edit Twitter</h5>
                                        <div class="form-group emoji_parent">
                                            <textarea onkeyup="updateDiv(this)" onchange="suggested_text(this)" required name="twitter_content" id="" cols="30" rows="3" class="form-control wizard-required emojiarea " placeholder="Write your post...">{{old('twitter_content')}}</textarea>
                                        </div>
                                        <div class="icon_buttons_tags mt-3">
                                            <div class="icon_buttons grid_item">
                                                <ul class="p-0">
                                            ...
                                            <div class="tags_input_wrap grid_item">
                                                <div class="tags_input">
                                                    <input onkeyup="Namechangefun(this)" id="namechange" name="twitter_tag" type="text" class="form-control ai-tag" placeholder="tags" value="{{old('twitter_tag')}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group clearfix">
                                    ...
                                    <fieldset class="wizard-fieldset linkedin">
                                        ...
                                        <div class="form-group emoji_parent">
                                            <textarea onkeyup="updateDiv(this)" onchange="suggested_text(this)" required name="linkedin_content" id="" cols="30" rows="3" class="Customemojiarea form-control wizard-required emojiarea " placeholder="Write your post...">{{old('linkedin_content')}}</textarea>
                                        </div>
                                        <div class="icon_buttons_tags mt-3">
                                            <div class="icon_buttons grid_item">
                                                <ul class="p-0">
                                            ...
                                            <div class="tags_input_wrap grid_item">
                                                <div class="tags_input">
                                                    <input onkeyup="Namechangefun(this)" id="namechange" name="linkedin_tag" type="text" class="form-control ai-tag" placeholder="tags" value="{{old('linkedin_tag')}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group clearfix">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Time to upload
                                                        post</h1>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-primary d-none">Save
                                                        changes</button>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="actions-buttons">
                                        <ul class="actions-buttons-list d-flex p-0 justify-content-between">
                                            <li class="actions-buttons-item">
                                                <button class="actions-buttons-button"><i class="fa-solid fa-thumbs-up"></i><span class="text">Like</span>
                                                </button>
                                            </li>
                                            <li class="actions-buttons-item">
                                                <button class="actions-buttons-button"><i class="fa-solid fa-comment"></i><span class="text">Comment</span></button>
                                            </li>
                                            <li class="actions-buttons-item">
                                                <button class="actions-buttons-button"><i class="fa-solid fa-share"></i><span class="text">Share</span></button>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
