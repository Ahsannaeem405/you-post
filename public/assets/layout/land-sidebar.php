    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
            ...
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto">
                    <a class="navbar-brand" href="../admin/index.php">
                        ...
                        <h2 class="brand-text mb-0">Oto-Paid</h2>
                    </a>
                </li>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="land-properties-list.php"><i class="feather icon-help-circle"></i><span class="menu-title" data-i18n="FAQ">Properties</span></a></li>
                <li class=" nav-item"><a href="land-tenet.php"><i class="feather icon-info"></i><span class="menu-title" data-i18n="Knowledge Base">Tenets</span></a></li>
                <li class=" nav-item"><a href="land-transaction.php"><i class="feather icon-search"></i><span class="menu-title" data-i18n="Search">Transactions</span></a></li>
                <li class=" nav-item"><a href="page-invoice.html"><i class="feather icon-file"></i><span class="menu-title" data-i18n="Invoice">User profile</span></a></li>
            </ul>
        </div>
    </div>
    <!-- END: Main Menu-->