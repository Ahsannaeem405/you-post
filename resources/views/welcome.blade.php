            ...
            <div class="create_post">
                ...
                <form action="">
                    <div class="form-group">
                        <textarea name="" id="" cols="30" rows="3" class="form-control" placeholder="Write your post...">This is a sample post content block, the preview for this post will show up on the right</textarea>
                    </div>
