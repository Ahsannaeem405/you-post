<style>
    ...
    * {
    ...
    .sidebar {
        width: 88px;
        /* Default width when inactive */
        transition: width 0.3s;
        /* Optional: Add a transition for smoother width change */
    }
...
<button class="btn btn-primary mt-3 ms-1 borderless d-lg-none d-sm-block" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
    sidebar
</button>

<div class="offcanvas offcanvas-start d-lg-none d-sm-block" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
    ...
    <div class="menu-bar">
        <div class="menu">
            ...
            <ul class="menu-links menu_links">
                    ...
                    <div class="user_info pl-1">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                ...
                                <li><a class="dropdown-item {{auth()->user()->account_id==$account->id ? 'active' : null}}" href="{{url("change_acount/".encrypt($account->id))}}"><i class="fa-solid fa-user"></i> {{$account->name}}</a></li>
                                @endforeach
                ...
                <li><a href="javascript:void(0)" class="myaccounts"> <i class="fa-regular fa-message icon"></i><span class="text nav-text">Add Social Account</span></a></li>
                ...
                <li><a href="javascript:void(0)"><i class='bx bx-pie-chart-alt icon'></i><span class="text nav-text">Support</span></a></li>
