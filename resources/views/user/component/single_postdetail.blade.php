...
<div class="col-md-12 the_preview_card ">
            ...
            <div class="post_img">
                <div class="PostHeaderInner d-flex justify-content-between align-items-center">
                    <div class="d-flex justify-content-center align-items-start gap-1">
                        <img src="{{ $post->account_info['fb_image']}}" class="img-fluid " width="40" height="40"
                             alt="">
                        <div class="">
    ...
    <div class="MainMobileview MainMobileview2 mt-1 LinkedinWrap" style="display: none;">
        ...
        <div class="post_img_name">
            <div class="post_img">
                <div class="PostHeaderInner d-flex justify-content-between align-items-center">
                    <div class="d-flex justify-content-center align-items-start gap-1">
                        <img src="{{ $post->account_info['link_image'] }}" class="img-fluid" width="40"
                             height="40" alt="">
                        <div class="">
    ...
    <div class="MainMobileview MainMobileview2 mt-1 TwitterWrap" style="display: none;">
        ...
        <div class="post_img_name">
            <img src="{{$post->account_info['twt_image']}}" class="img-fluid Twitter_Profile" width="40" height="40"
                 alt="">
            <div class="post_img">
                <div class="PostHeaderInner d-flex justify-content-between align-items-center">
                    <div class="">
                        ...
                        <div class="">
                            <span>@ {{$post->account_info['tw_user_name']}}</span>
                            <!-- <span>Just Now</span> -->
                        </div>
                    </div>
                </div>
                ...
                <div class="NavBtmSec">
                    <ul class="actions-buttons-list d-flex p-0 m-0 justify-content-between w-100">
                        ...
                        <li class="actions-buttons-item d-flex align-item-center pt-1">
                            <img src="{{ asset('images/icons/share-twitter.svg') }}" class="" alt="" height="15"
                                 width="14">
                        </li>
                        <li class="actions-buttons-item  d-flex align-item-center share_fb">
                ...
                <div class="PostHeaderInner d-flex justify-content-between align-items-center">
                    <div class="d-flex justify-content-between align-items-center w-100 mb-2">
                        <div class="d-flex align-items-center gap-1">
                            <img src="{{$post->account_info['inst_image']}}" class="img-fluid" width="40" height="40"
                                 alt="">
                            <h5 class="m-0">{{$post->account_info['inst_page_name']}}</h5>
                        </div>
                        <div class="dropdown">
                            <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1"
                                    data-bs-toggle="dropdown" aria-expanded="false" disabled>
