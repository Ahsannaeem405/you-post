...
<i class='bx bx-chevron-right toggle' id="arrow-icon"></i>

<nav class="sidebar side_bar close" id="sidebar-toggle" style="width: 250px; z-index: 9999;">
    <header>
...
<script>
    ...
    //     //     $(this).css('z-index', '1');
    //     //     $(".text").css('opacity', '1');
    //     //     console.log("Sidebar open toggled");
    //     // });
