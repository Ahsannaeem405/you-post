...
<body>
    <table border="0" cellspacing="0" cellpadding="0" align="center"
        style="width: 500px; margin: 0 auto;border-radius: 10px;background-color: #ddd;">
        <tr>
            <td
        ...
        <tr>
            <td>
                <table border="0" cellspacing="0" cellpadding="0" align="center" width="100%"
                    style="padding-left: 22px;padding-right: 22px;padding-bottom: 22px;">
                    <tr>
                        <td>
                            <h1
                    ...
                    <tr>
                        <td>
                            <p
                                style="font-size: 18px;margin-top: 10px;margin-bottom: 10px;font-family: 'Poppins', sans-serif; ">
                                {{ $details['body'] }}</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <p
                                style="font-size: 16px;margin-top: 10px;margin-bottom: 10px;font-family: 'Poppins', sans-serif; text-align:center;font-weight:600;">
                                Thank You!</p>
                        </td>
                    </tr>
                </table>
