    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
            ...
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto">
                    <a class="navbar-brand" href="../admin/index.php">
                        ...
                        <h2 class="brand-text mb-0">Oto-pid</h2>
                    </a>
                </li>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="properties-list.php"><i class="feather icon-help-circle"></i><span class="menu-title" data-i18n="FAQ">Properties</span></a></li>
                <li class=" nav-item"><a href="tenet-user.php"><i class="feather icon-file"></i><span class="menu-title" data-i18n="Invoice">User profile</span></a></li>
            </ul>
        </div>
    </div>
    <!-- END: Main Menu-->