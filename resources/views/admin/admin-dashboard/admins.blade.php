                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="table-wraper-1">
                                        ...
                                        <table id="special2" class="display nowrap" style="width:100%">
                                            <thead class=''>
                                            <tr>
                                                <th>Name</th>
                                                <th>Email</th>
                                            ...
                                            @foreach($admins as $user)
                                                ...
                                                <span class="dropdown-toggle" id="dropdownMenuIconButton3"
                                                    ...
                                                    <td>
                                                        ...
                                                        <!-- <input type="checkbox" class="js-switch disabled" data-record-id="{{ $user->id }}" {{ $user->disabled ? 'checked' : '' }}/></td> -->
                                                </tr>
                                            @endforeach
                                            </tbody>
                                        </table>
                    ...
                    <form id="editForm">
                        ...
                        <div class="form-group">
                            ...
                            <input id="edit_email" type="email"
                                   class="form-control @error('email') is-invalid @enderror" name="edit_email"
