...
$(window).on("load", function(){
    ...
    var barChartoption = {
        ...
        dataset: {
            source: [
                ['product' , '2016', '2017'],
                ['Jan', randomize(), randomize()],
                ['Feb', randomize(), randomize()],
                ['March', randomize(), randomize()],
                ['April', randomize(), randomize()],
                ['May', randomize(), randomize()],
                ['June', randomize(), randomize()],
                ['July', randomize(), randomize()],
                ['August', randomize(), randomize()],
                ['Sep', randomize(), randomize()],
                ['Oct', randomize(), randomize()],
                ['Nov', randomize(), randomize()],
                ['Dec', randomize(), randomize()],
            ],
        },
        xAxis: {
            type: 'category',
