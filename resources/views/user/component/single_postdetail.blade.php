...
<div class="col-md-12 the_preview_card">
    ...
    <div class="MainMobileview MainMobileview2 mt-1 Instagram">
        <div class="PostHeader d-flex justify-content-between align-items-center">
            <h5 class="HeadingTop"><img src="{{ asset('images/Twitter_Color.png') }}" alt="" class="mr-1">
                Instagram</h5>
        ...
        <div class="post_img_name">
            <div class="post_img">
                ...
                <div class="DetailText pt-0">
                    <p class="short_text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Itaque ex aperiam
                        doloribus exercitationem reprehenderit quo, ipsam architecto perferendis sapiente eaque, qui
                        provident? Sapiente delectus, perspiciatis deserunt veritatis cupiditate possimus cum. <span
                            id="show-button">See more</span></p>
                </div>
                <div class="TagsSec">
                    <a href="#">#BrownTechInt</a>
                </div>
                    ...
                    @if ($post->plateform === 'Facebook' && auth()->check() && auth()->user()->account && auth()->user()->account->fb_image)
                        <a href="{{ $newvar['fb_feed'] }}" target="_blank" style="font-size:12px;"
                            ...
                            @if ($post->posted_at_moment == 'now')
                                <img src="{{ asset('images/copy.png') }}" class="" alt="" /> View post
                                in live feed
                            @endif
                        </a>
                    @elseif($post->plateform === 'Instagram' && auth()->check() && auth()->user()->account && auth()->user()->account->fb_image)
