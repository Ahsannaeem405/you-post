                        ...
                        <div class="dropdown">
                            <button class="dropdown-toggle bg-transparent border-0 dropdown_btn" type="button"
                                ...
                                @elseif(in_array("Instagram", $platforms))
                                    <img src="{{ auth()->user()->account->inst_image}}" class="v_icon rounded-circle"
                                         alt=""
                                         width="45px"/>

                                @elseif(in_array("Twitter", $platforms))
                                    <img src="{{auth()->user()->account->twt_image}}" class="v_icon rounded-circle"
                                         alt=""
                                         width="45px"/>
                                @elseif(in_array("Linkedin", $platforms))
                                    <img src="{{ auth()->user()->account->link_image}}" class="v_icon rounded-circle"
                                         alt=""
                                         width="45px"/>
                                @else
    ...
    <div class="menu-bar">
        <div class="menu">
            ...
            <ul class="menu-links menu_links">
                ...
                <li><a href="javascript:void(0)" class="font-size-small" id="" data-bs-toggle='modal'
