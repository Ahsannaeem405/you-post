     ...
     <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="post-detail">
                <h5 class="modal-title detail_modalLabel2" id="detail_modalLabel">
                    <a href="#"><img src="{{asset('images/Info.png')}}" class="" alt=""/></a>Post Details</h5>
            </div>
                                ...
                                <div class="col-5 d-flex align-items-center">
                                    <div>
                                        ...
                                        <p class="text-warning text-center mb-0"
                                            style="font-size:11px; padding-right:0px;">
                                            (In case of
                                            published)</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div
                                        ...
                                        <div class="actions-buttons-button d-flex">
                                            <div><i class="fa-solid fa-circle-user account_icon"></i></div>
                                             &nbsp;
                                            <div class="mt-1">
