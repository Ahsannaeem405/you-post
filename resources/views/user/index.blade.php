...
@section('content')
            ...
            <div class="create_preview_post create_preview_post_index">
                                        ...
                                        <div class="form-wizard card my-2">
                                            ...
                                            <fieldset class="wizard-fieldset youpost ">
                                                ...
                                                <div class="form-group emoji_parent emoji_parent2" data-emoji='youpost'>
                                                    <textarea onkeyup="updateDiv(this)" onchange="updateDiv_other(this)" name="youpost_content" id="youpost_content"
                                                        cols="30" rows="10" class="form-control wizard-required emojiarea mention" data-id="youpost_error"
                                                ...
                                                <div id="image_div_youpost" class="image_div_2"><label for="file"
                                                        ...
                                                        <div class="sm_container" id="12">
                                                            ...
                                                            <input type="hidden" name="youpost_video"
                                                                id="youpost_video">
                                            ...
                                            @if (in_array('Facebook', auth()->user()->account->platforms))
                                                <fieldset class="wizard-fieldset fb">
                                                    ...
                                                    <div class="form-group emoji_parent emoji_parent2">
                                                        <textarea onkeyup="updateDiv(this)" onchange="suggested_text(this)" name="facebook_content" id="facebook_content"
                                                            cols="30" rows="10" class="form-control wizard-required emojiarea mention" data-id="facebok_error"
                                            ...
                                            @if (in_array('Instagram', auth()->user()->account->platforms))
                                                <fieldset class="wizard-fieldset insta">
                                                    ...
                                                    <div class="form-group emoji_parent emoji_parent2 ">
                                                        <textarea onkeyup="updateDiv(this)" onchange="suggested_text(this)" name="instagram_content" id="instagram_content"
                                                            cols="30" rows="10" class="form-control wizard-required emojiarea" data-id="insta_error"
                                            ...
                                            @if (in_array('Twitter', auth()->user()->account->platforms))
                                                <fieldset class="wizard-fieldset twitter">
                                                    ...
                                                    <div class="form-group emoji_parent  emoji_parent2">
                                                        <textarea datatype="fsdf" onkeyup="updateDiv(this)" onchange="suggested_text(this)" name="twitter_content"
                                                            id="twitter_content" cols="30" rows="10" data-id="twitter_error"
                                                            class="form-control wizard-required emojiarea mention" placeholder="Write your post..." plt-name="fb">{{ old('twitter_content') }}</textarea>
                                                    ...
                                                    <div id="image_div_twi"><label for="file"
                                                            style="margin-top: 20px;">
                                                            ...
                                                            <div class="sm_container">
                                                                ...
                                                                <input type="hidden" name="twitter_video"
                                                                    id="twitter_video">
                                                            </div>
                                                        </label>
                                                    </div>
                                                    <p class=" p-2  w-100 d-none mt-2 erro_background"
                                                        id="file_error_twiiter">
                                                    </p>
                                                    <div class="form-group clearfix clearfix2">
                                                        <!-- <a href="javascript:;"
                                                        class="form-wizard-previous-btn float-left">Back</a>
                                            ...
                                            @if (in_array('Linkedin', auth()->user()->account->platforms))
                                                <fieldset class="wizard-fieldset linkedin">
                                                    ...
                                                    <div class="form-group emoji_parent emoji_parent2">
                                                        <textarea onkeyup="updateDiv(this)" onchange="suggested_text(this)" name="linkedin_content" id="linkedin_content"
                                                            cols="30" rows="10" data-id="link_error"
                                                            class="Customemojiarea form-control wizard-required emojiarea mention " placeholder="Write your post...">{{ old('linkedin_content') }}</textarea>
                                                        <div id="dropdown" class="dropdown-content-search"></div>
                                                    </div>
                                                    <div class="icon_buttons_tags mt-3">
                                                        <div class="icon_buttons grid_item">
                                                    ...
                                                    <div id="image_div_linked"><label for="file"
                                                            style="margin-top: 20px;">
                        ...
                        <div class="preview_post position-relative" style="width: 80%">
                            ...
                            <div class="preview_wrap add_preview  prv_youpost prev_wrap_youpost">
                                ...
                                <div class="Mobcompny-smallicon Mobcompny_smallicon pt-2 px-2 pb-1 d-none">
                                    ...
                                    <div class="one_img"><img src="{{ asset('images/ad.png') }}" class=""
                                            alt=""></div>
                                    <div class="one_img messenger"><img src="{{ asset('images/you.png') }}"
                                            class="" alt="">
                                    ...
                                    <div class="one_img mb-1"><img src="{{ asset('images/bell.png') }}" class=""
                                            alt="">
                                    </div>
                                    <div class="one_img"><img src="{{ asset('images/br.png') }}" class=""
                                            alt=""></div>
                                </div>
                                ...
                                <div class="the_preview ">
                                    <div class="col-md-12 the_preview_card" style="height: 80px">
                                        <div
                                            class="MainMobileview MainMobileview2 d-flex justify-content-between mt-1 youpost_prev">
                                        ...
                                        <div class="Mobcart_title mobprev_container">
                                            <span id="mypostresult_youpost" class="mypostresult mob_prevcontent">Write
                                                your universal content...</span>
                                    ...
                                    <div class="col-md-12">
                                        <div
                                            ...
                                            <div
                                                ...
                                                <img src="{{ asset('') }}images/fb_thumb.png" class=""
                                                    alt="" height="12" />
                                                <img src="{{ asset('') }}images/fb_heart.png" class="thums_up"
                                                    alt="" height="12" />
                                            </div>
                            ...
                            @if (in_array('Facebook', auth()->user()->account->platforms))
                                <div class="preview_wrap d-none add_preview  prv_fb prev_wrap_fb">
                                    ...
                                    <div class="Mobcompny-smallicon Mobcompny_smallicon pt-2 px-2 pb-1">
                                        ...
                                        <div class="one_img messenger marketicon">
                                            <img src="{{ asset('images/marketplace2.png') }}" class=""
                                                alt="">
                                            <div class="msg_1 icon_opc d-none">
                                                <p>1</p>
                                            </div>
                                        </div>
                                        <div class="one_img mb-1"><img src="{{ asset('images/bell.png') }}"
                                                class="" alt="">
                                        </div>
                                        <div class="one_img"><img src="{{ asset('images/br.png') }}" class=""
                                                alt=""></div>
                                    ...
                                    <div class="the_preview">
                                        <div class="col-md-12 the_preview_card" style="height: 80px">
                                            <div
                                                ...
                                                <div class="post_img_name youpost_prev_name">
                                                    <div class="post_img youpost_prev_img">
                                                        <img src="{{ auth()->user()->account->fb_image }}"
                                                            class="img-fluid" width="40" height="40"
                                                            alt="">
                                                    </div>
                                                    <div>
                                                        <span id=""
                                                            class="postname">{{ auth()->user()->account->fb_page_name }}
                                                            <br>
                                                            <span class="sponsored">Public . <i
                                                                    class="fa-solid fa-earth-americas"></i></span>
                                                        </span>
                                            ...
                                            <p class="m-0"></p>
                                            <div class="Mobcart_title mobprev_container">
                                                <span id="mypostresult_fb" class="mypostresult mob_prevcontent">Write your
                                                    post...</span>
                                                <span class="icon icon-privacy text-primary" id="mynameresult"></span>
                                            </div>
                                            <div id="selectedValues"></div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="actions-buttons actions_buttons px-1 mt-2">
                                                <ul class="actions-buttons-list d-flex p-0 justify-content-between">
                                                    ...
                                                    <li class="actions-buttons-item d-flex align-item-center pt-1">
                                                        <img src="{{ asset('') }}images/coment_msg.png"
                                                            class="" alt="" height="15"
                                                            width="14" />
                                                        <span class="text text2">Comment</span>
                                                    </li>
                                    ...
                                    <div class="the_preview">
                                        <div class="d-flex justify-content-between  px-2">
                                            <div class="d-flex gap-4">
                                                <div style="cursor:pointer;"> <i class="fa-solid fa-arrow-left mt-1"></i>
                                                </div>
                                        ...
                                        <div class="row px-2">
                                                ...
                                                <div
                                                    ...
                                                    <div class="actions-buttons-button show active">
                                                        <div class="d-flex show active" style="gap: 0 10px;">
                                                            <img class="ins_icon"
                                                                src="{{ asset('images/icons8-heart1.png') }}"
                                                                alt="" style="cursor:pointer;">
                                                            <img class="ins_icon"
                                                                src="{{ asset('images/bubble-chat.png') }}"
                                                                alt="" style="cursor:pointer;">
                                                            <img class="ins_icon" src="{{ asset('images/send1.png') }}"
                                                                alt="" style="cursor:pointer;">
                                                        </div>
                                                    </div>
                                            ...
                                            5px">
                                                ...
                                                <img  class="" src="{{ asset('images/dotg.png') }}" alt="" style="cursor:pointer; height:9px;width:9px">
                                                    ...
                                                    <div class="actions-buttons-button d-flex">
                                                        <img class="ins_icon" src="{{ asset('images/myiconsave.png') }}"
                                                            alt="" style="cursor:pointer;">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-12" style="height:56px">
                                                <div class="Mobcart_title mobprev_container">
                                                    <span id="mypostresult_insta" class="mypostresult mob_prevcontent"
                                                        style="color:#000;">Write
                                                        your
                                                        post...</span>
                                                    <span class="icon icon-privacy text-primary"
                                                        id="mynameresult_insta"></span>
                                                </div>
                                                <div id="selectedValues"></div>
                                            </div>
                                            <div class="col-12">
                                            ...
                                            <div class="col-12 insta_pos_acc_icons py-2">
                                                <div class="insta_acc_bar_parent">
                                                    <img src="{{ asset('images/Home-01.png') }}" alt=""
                                                        class="insta_acc_bar">
                                                    <img src="{{ asset('images/search-01.png') }}" alt=""
                                                        class="insta_acc_bar">
                                                    <img src="{{ asset('images/Plus-01.png') }}" alt=""
                                                        class="insta_acc_bar">
                                                    <img src="{{ asset('images/Movie-01.png') }}" alt=""
                                                        class="insta_acc_bar">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-9 colum_nine">
                                                ...
                                                <div class="twitter_header">
                                                    <div>
                                                        <span class="twitter_post_content">
                                                            ...
                                                            src="{{ asset('images/offical2.png') }}" class="d-none"
                                                            alt="">
                                            ...
                                            <div class="twitter_text pb-1 mobprev_container">
                                                <span id="mypostresult_twitter" class="mypostresult mob_prevcontent">Write
                                                    your post...</span>
                                                <span id="mynameresult_twitter"
                                                    class="icon icon-privacy text-primary"></span>
             ...
             <source src="movie.mp4" type="video/*">
                                        ...
                                        <div class="x_bar_icons pt-1 col-12">
                                            <div>
                                                <img src="{{ asset('') }}images/icons/Comment-titter.svg"
                                                    class="" alt="" />
                                                <span>0</span>
                                            </div>
                                            <div>
                                                <img src="{{ asset('') }}images/icons/share-twitter.svg"
                                                    class="" alt="" />
                                                <span>0</span>
                                            </div>
                                            <div>
                                                <img src="{{ asset('') }}images/icons/heart-twitter.svg"
                                                    class="" alt="" />
                                                <span>0k</span>
                                            </div>
                                            <div class="d-flex mt-1 gap-1">
                                                <img src="{{ asset('') }}images/icons/graph.svg" class=""
                                                    alt="" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="linkedin_post mobprev_container">
                                                <span id="mypostresult_linkedin"
                                                    class="mypostresult mob_prevcontent">Write your post...</span>
                                                <span id="mynameresult_linkedin"
                                                    class="icon icon-privacy text-primary"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="LikeIcons px-2 d-none">
                                                <div class="d-flex">
                                                    <div class="InnerIcon">
                                                        <img src="{{ asset('images/icons/linkedin-laugh.svg') }}"
                                                            alt="" height="12">
                                                        <img src="{{ asset('images/icons/linkedin-thumb.svg') }}"
                                                            alt="" height="12" style="margin: 0 0 0 -7px;">
                                                        <img src="{{ asset('images/icons/linkedin-heart.svg') }}"
                                                            alt="" height="12">
                                                    </div>
                                                    <span
                                                        style="color:#888d91; font-size:10px; padding-top:7px;">345</span>
                                                </div>
                                            ...
                                            <div class="ActionBtn_Linkedin">
                                                <ul class="LI_Like">
                                                    <li>
                                                        <button>
                                                            <img src="{{ asset('images/icons/thum-linkedin.svg') }}"
                                                                alt="" height="18">
                                                    ...
                                                    <li>
                                                        <button>
                                                            <img src="{{ asset('images/icons/comment-linkedin.svg') }}"
                                                                alt="" height="18">
                                                    ...
                                                    <li>
                                                        <button>
                                                            <img src="{{ asset('images/icons/share-linkedin.svg') }}"
                                                                alt="" height="18">
                                                    ...
                                                    <li>
                                                        <button>
                                                            <img src="{{ asset('images/icons/send-linkedin.svg') }}"
                                                                alt="" height="18">
                                            ...
                                            <div class="linkedin_icons d-flex px-1">
                                                ...
                                                <div class="btm_icon">
                                                    <div style="text-align:center;"><img
                                                            src="{{ asset('images/postlinked.png') }}" alt="">
                                                    </div>
                                                    <div><span>Post</span></div>
                                                </div>
                                                <div class="btm_icon btm_icon_notification">
                                                    <div style="text-align:center;"><img
                                                            src="{{ asset('images/updatebellicon.png') }}"
                                                            alt=""></div>
                                                ...
                                                <div class="btm_icon">
                                                    <div style="text-align:center;"> <img
                                                            src="{{ asset('images/jobs.png') }}" alt=""></div>
                                ...
                                <div class="AIgeneratedContentData">
                                    <div>
                                        ...
                                        <div class="add_caption">
                                            <a href="javascript:void(0)">
                                                ...
                                                <img src="{{ asset('images/add.png') }}" class="img-fluid add_icon"
                                                    alt="" />
                                            </a>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div class="add_caption">
                                            ...
                                            <p id="slect_drop" class="js-example-basic-single form-control"
                                                name="state">
                                                Facebook + <br>
                                                Instagram +
                                            </p>
                    ...
                    <div class="col-12">
                        <div class="dropdown dropdown1 ">
                            <button style="background-color:#6CB0FF; border:none;"
                                class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton1"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                Last 7 days <img src="{{ asset('images/vector.png') }}" class="img-fluid"
                                    alt="" />
                                                ...
                                                <div>
                                                    <div class="oval-img-div d-flex ">
                                                        <div class="cirle-img fb-image">
                                                            ...
                                                            <img src="{{ asset('') }}images/Oval (1).png"
                                                                class=" x-com-img" alt="" />
                                                        </div>
    ...
    <div class="modal fade" id="postSuccessModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                ...
                <div class="modal-body pb-0 mb">
                    <div class="woohoo mt-5">
                        ...
                        <div class="success_social_icons">
                            @if (isset($platforms))
                                @if (in_array('Facebook', $platforms))
                                    <div class="success_fb"><a href=""><img
                                                src="{{ asset('') }}images/FB_Color.png" class="img-fluid"
                                                alt="" /></a>
                                    </div>
                                @endif
                                @if (in_array('Instagram', $platforms))
                                    <div class="success_fb"><a href=""><img
                                                src="{{ asset('') }}images/Instagram_Color.png" class="img-fluid"
                                                alt="" /></a>
                                    </div>
                                @endif
                                @if (in_array('Twitter', $platforms))
                                    <div class="success_fb"><a href=""><img
                                                src="{{ asset('') }}images/Twitter_Color.png" class="img-fluid"
                                                alt="" /></a>
                                    </div>
                                @endif
                                @if (in_array('Linkedin', $platforms))
                                    <div class="success_fb"><a href=""><img
                                                src="{{ asset('') }}images/Linkedin_Color.png" class="img-fluid"
                                                alt="" /></a>
                                    </div>
                                @endif
                            @endif
                        ...
                        <div class="success_modal_para mt-3">
                            ...
                            <p class="mb-0">You just @if (!session()->has('IsScheduled'))
                                    published
                                @else
                                    scheduled
                                @endif
                                your
                                @if (!session()->has('check_first_post'))
                                    first
                                @endif
                                post! Keep @if (!session()->has('IsScheduled'))
                                    posting
                                @else
                                    scheduling
                                @endif and let the
                                world know what you’ve got to say.
                            </p>
                        </div>
                        @php
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.form-wizard-previous-btn').click(function() {
                ...
                var classAttribute = prev.parents('.wizard-fieldset').prev('.wizard-fieldset').attr(
                'class');
                var classNames = classAttribute.split(" ");

                currentActiveStep.removeClass('active').prev().removeClass('activatedold').addClass(
                    'active',
                    "400");
                $(document).find('.wizard-fieldset').each(function() {
                    if ($(this).hasClass('show')) {
