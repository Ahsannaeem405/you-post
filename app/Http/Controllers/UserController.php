...
//        dd($api->body(),$api->status());
    ...
    public function create_post(Request $req)
    {
        ...
        public
        function get_events(Request $request)
        {
        ...
        public
        function post_delete($id, Facebookservice $facebookservice, Instagramservice $Instagramservice, Linkedinservice $Linkedinservice, TwitterService $TwitterService)
        {
        ...
        public
        function update_user_platforms(Request $req)
        {
        ...
        public
        function connect_to_facebook($account = null)
        {
            if ($account) {
                auth()->user()->update([
                    'account_id' => $account
        ...
        public
        function connect_facebook_calback(Request $request)
        {
            $fb = new Facebook([
                'app_id' => env('app_id'),
                'app_secret' => env('app_secret'),
        ...
        public
        function connect_to_instagram($account = null)
        {
            if ($account) {
                auth()->user()->update([
                    'account_id' => $account
        ...
        public
        function connect_instagram_calback(Request $request)
        {
            $insta = config('services.instagram');
            $fb = new Facebook([
                'app_id' => $insta['client_id'],
        ...
        public
        function get_page_for_instagram()
        {
        ...
        public
        function set_page_for_instagram(Request $req)
        {
            $req->validate([
                'page' => 'required',
            ]);
        ...
        public
        function connect_to_linkedin($account = null)
        {
            if ($account) {
                auth()->user()->update([
                    'account_id' => $account
        ...
        public
        function connect_linkedin_calback(Request $request)
        {
            try {
                $linkedin = config('services.linkedin');
        ...
        public
        function set_page_for_linkedin(Request $req)
        {
            $req->validate([
                'page' => 'required',
            ]);
        ...
        public
        function connect_to_twitter($account = null)
        {
            if ($account) {
                auth()->user()->update([
                    'account_id' => $account
        ...
        public
        function connect_twitter_calback(Request $request)
        {
            try {
                $twitter = config('services.twitter');
        ...
        public
        function get_facebook_likes(Facebookservice $facebookservice, Instagramservice $instagramservice, TwitterService $twitterService)
        {
