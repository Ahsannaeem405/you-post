                                        ...
                                        <div class="form-wizard card my-2">
                                            ...
                                            @if(in_array(('Facebook'),auth()->user()->account->platforms))
                                                <fieldset class="wizard-fieldset fb">
                                                    ...
                                                    <p class=" bg-warning text-white p-2  w-100 d-none mt-2" id="file_error_fb"></p>
                                                    <!-- append div waleed start -->
                                                    <!-- end my coed -->
                                            ...
                                            @if(in_array(('Instagram'),auth()->user()->account->platforms))
                                                <fieldset class="wizard-fieldset insta">
                                                    ...
                                                    <p class=" bg-warning text-white p-2  w-100 d-none mt-2" id="file_error_insta"></p>
                                            ...
                                            @if(in_array(('Linkedin'),auth()->user()->account->platforms))
                                                <fieldset class="wizard-fieldset linkedin">
                                                    ...
                                                    <p class=" bg-warning text-white p-2  w-100 d-none mt-2" id="file_error_linkedin"></p>
                                                    <div class="form-group clearfix clearfix2">
                                                        <a href="javascript:;"
                                                           class="form-wizard-previous-btn float-left">Back</a>
                                                        <a href="javascript:;" class="form-wizard-next-btn float-right">Next
                    ...
                    <div  class="create_preview_post_index_item create_preview_post_index_itemRight section2_rightcard mx-2 my-2 ">
                        ...
                        <div   class="d-lg-flex justify-content-center post_preview_small_screen create_preview_post_index_itemRightInner">
                            <!-- <div class="preview_post position-relative" style="width: 80%!important;"> -->
                                ...
                                <!-- FACE BOOK DIV -->
                            <div class="preview_post position-relative  d-none" style="width: 80%" id="fb_preview">
                             ...
                             <!-- INSTA DIV -->
                             <div class="preview_post position-relative d-none" style="width: 80%" id="ins_preview">
                                <div class="sub_heading">
                                    <h4>Post Preview insta</h4>
                                </div>
                               ...
                               <!-- TWITTER DIV -->
                               <div class="preview_post position-relative  d-none" style="width: 80%" id="tw_preview">
                                <div class="loader d-none"></div>
                                <div class="sub_heading">
                                    <h4>Post Preview</h4>
                                </div>
                               ...
                               <!-- LINKED DIV -->
                               <div class="preview_post position-relative  d-none" style="width: 80%" id="link_preview">
                                <div class="loader d-none"></div>
                                <div class="sub_heading">
                                    <h4>Post Preview</h4>
                                </div>
                        ...
                        <div class="success_social_icons">
                            @if (isset($platforms))
                                ...
                                @if (in_array('Facebook', $platforms))
                                    <div class="success_fb"><a href=""><img src="{{asset('')}}images/FB_Color.png"
                                                                            class="img-fluid"
                                                                            alt=""/></a>
                                    </div>
                                @endif
        ...
        <script>
            $(document).ready(function () {
                ...
                $('.form-wizard-next-btn').click(function () {
                    ...
                    if (nextWizardStep) {
                        ...
                        if (nextFieldset.length > 0) {
                            ...
                            currentActiveStep.removeClass('active').next().addClass(
                                'active',
                                "400");
                ...
                $('.form-wizard-previous-btn').click(function () {
                    ...
                    currentActiveStep.removeClass('active').prev().addClass('active',
                        "400");
                    $(document).find('.wizard-fieldset').each(function () {
                        if ($(this).hasClass('show')) {
                            var formAtrr = $(this).attr('data-tab-content');
            ...
            for (let i = 0; i < 6; i++) {
                ...
                for (let j = 0; j < 7; j++) {
                    if (dayNum <= 0) {
                        ...
                        const formattedDate = `${String(month + 1).padStart(2, '0')}/${String(dayNum).padStart(2, '0')}/${year}`;

                        tableHtml += `<td class="${dayClass}" data-date="${formattedDate}">${String(dayNum).padStart(2, '0')}</td>`;
                    } else {
                        tableHtml +=
