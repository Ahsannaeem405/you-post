    ...
    @if(in_array('Facebook',$platformsName))
        <li class="nav-item" role="presentation">
            <a class="nav-link " id="tab1-tab" data-bs-toggle="tab" href="#tab1"
               role="tab" aria-controls="tab1" aria-selected="true"><img src="{{asset('images/FB_Color.png')}}"
                                                                         class="socialfb" alt=""/></a>
        </li>
    @endif
        ...
        <div class="tab-pane fade " id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
            <div class="nav_card1 mt-3">
                <div class="row p-3">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="Evano">
                                <h3 class="mb-0">{{$platforms['Facebook'][0]->user->name}}
                                    <img src="{{asset('images/offical2.png')}}" class="" alt="" height=""/></h3>
                    ...
                    <div class="col-5">
                        <div>
                            <a href="" style="font-size:12px;"><img src="{{asset('images/copy.png')}}" class="" alt=""/>View post in live feed</a>
                            <p class="text-warning text-center" style="font-size:12px; padding-right:26px;">(In case of published)</p>
                        </div>
                    </div>
                    <div class="col-12">
                ...
                <div class="row p-3">
                    <div class="col-7">
                        <div class="d-flex">
                            ...
                            <div class="Evano">
                                <h3 class="mb-0">{{$platforms['Instagram'][0]->user->name}} <img src="{{asset('')}}images/offical.png" class="" alt="" height="14"/></h3>
                                <span class="text-secondary">Scheduled at:</span>
                                <span class="text-primary">{{\Carbon\Carbon::parse($platforms['Instagram'][0]->posted_at)->format('d M Y h:i A')}}</span>
        ...
        <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
            ...
            <div class="nav_card1 mt-3 navcard_3">
                <div class="row p-3">
                    ...
                    <div class="col-10">
                        <div class="Evano">
                            <h3 class="mb-0">{{$platforms['Twitter'][0]->user->name}} <img src="{{asset('')}}images/offical.png" class="" alt="" height="14"/></h3>
                            <span class="text-secondary">Scheduled at:</span>
        ...
        <div class="tab-pane fade" id="tab4" role="tabpanel" aria-labelledby="tab4-tab">
            ...
            <div class="nav_card1 mt-3">
                <div class="row">
                    ...
                    <div class="col-10">
                        <div class="Evano">
                            <h3 class="mb-0">{{$platforms['Linkedin'][0]->user->name}} <img src="{{asset('')}}images/offical.png" class="" alt="" height="14"/></h3>
                            <span class="text-secondary">Scheduled at:</span>
                            <span class="text-primary">{{\Carbon\Carbon::parse($platforms['Linkedin'][0]->posted_at)->format('d M Y h:i A')}}</span>
